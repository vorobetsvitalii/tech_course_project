...
const std::string Constants::loginApi = "/api/login";
const std::string Constants::logoutApi = "/api/logout";
...
const std::string Constants::subcategoriesArrayJson = "subcategories";
const std::string Constants::TeamsArrayJson = "Teams";
